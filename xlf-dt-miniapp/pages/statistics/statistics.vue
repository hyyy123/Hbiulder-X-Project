	...
	<view>
		...
		<view>
			<view class="clearfix" style="margin:10px;border:1px #f1f1f1 solid;margin-top:0;margin-bottom: 20px;">
				<view class="dayTime">
					<DyDate @getData="getData" name="start" :maxSelect="end==''?'2050/12/31':end" placeholder="开始时间" ></DyDate>
				</view>
				<view style="float: left;width: 20px;line-height: 30px;">~</view>
				<view class="dayTime">
					<DyDate @getData="getData" name="end" :minSelect="start==''?'1900/01/01':start" placeholder="结束时间"></DyDate>
				</view>
			</view>
